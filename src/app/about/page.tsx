    ...
    <div className="min-h-screen bg-[#0B132B] text-white">
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-4xl text-center">
          <p className="text-sm uppercase tracking-widest text-white/50 mb-6">Our Story</p>
      ...
      <section className="py-20 px-6">
        <div className="mx-auto max-w-4xl text-center bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-12">
          ...
          <Link
            href="/signup"
            className="inline-flex items-center gap-2 bg-white text-[#0B132B] hover:bg-white/90 px-8 py-3 rounded-md font-medium transition-colors"
          >
            Get Started
