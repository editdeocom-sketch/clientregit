...
export default function SignupPage() {
  ...
  const canSignup = fullName && password && confirmPassword && pwValidation.valid && passwordsMatch && !signupLoading;
  ...
  async function handleSignup() {
    ...
    // Sign out and redirect to login (password not set during OTP flow)
    await supabase.auth.signOut();
    toast.success("Account created! Please log in with your email and set a password.");
    router.push("/login");
    setSignupLoading(false);
  }
